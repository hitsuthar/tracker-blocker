...
import static com.hitsuthar.tracker.data.TrackerList.TRACKER_HOSTLIST;
...
public class TrackersListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TrackersListAdapter(Context c, RecyclerView v, Integer appUid, String appId) {
        mContext = c;
        mAppUid = appUid;
        mAppId = appId;
                    ...
                    new ArrayAdapter<Tracker>(mContext, R.layout.list_item_trackers_details, trackerCategory.getChildren()) {
                        ...
                        private void updateText(TextView tv, Tracker t) {
                            ...
                            if (!categoryBlocked || Util.isPlayStoreInstall()) {
                                ...
                                int color = ContextCompat.getColor(getContext(), companyBlocked ? R.color.blocked : R.color.allowed);
